...
var mockSuperModule = require('../../../mocks/mockSuperModule');
var basePaymentMock = require('../../../mocks/models/basePayment');
...
describe('Payment', function () {
    ...
    before(function () {
        mockSuperModule.create(basePaymentMock);
        autoShipPaymentMethods = proxyquire('../../../../cartridges/int_ordergroove/cartridge/scripts/autoShipPaymentMethods', {
            'dw/util/ArrayList': ArrayList,
            'dw/system/HookMgr': HookMgr,
            'dw/system/Site': Site,
            'dw/order/BasketMgr': BasketMgr
        });
        PaymentModel = proxyquire('../../../../cartridges/int_ordergroove/cartridge/models/payment', {
            '*/cartridge/scripts/autoShipPaymentMethods': autoShipPaymentMethods,
            'dw/system/HookMgr': HookMgr
        });
    });
    ...
    it('should call the payment method filter', function () {
        var result = new PaymentModel(createApiBasket({ paymentMethods: paymentMethods }), null);
        assert.ok(result.applicablePaymentMethods);
    });
});
